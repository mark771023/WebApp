...
namespace _03View.Controllers
{
    public class HomeController : Controller
    {
        ...
        public ActionResult Index(int page = 1)
        {
            ...
            List<Nightmarket> list = new List<Nightmarket>(); //泛型: 用Nightmarket鑄造出來的物件清單
            ...
            //03-7-2 修改Home Controller 裡Index actoin內容(必須Using Namespace)
            int pagesize = 3;
            int pagecurrent = page < 1 ? 1 : page; //page 小於1嗎? 是的話就到第一頁,否則就在當下的網頁, 防呆機制
