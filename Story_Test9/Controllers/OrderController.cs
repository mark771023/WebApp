...
namespace Story_Test9.Controllers
{
    public class OrderController : Controller
    {
        ...
        public ActionResult OrderDetail(string OrdID)
        {
            var OrderOrderMapping = db.OrderMapping.Where(m => m.OrdID == OrdID).ToList();

            return View("OrderDetail", "_LayoutMember", OrderOrderMapping);
        }
